...
5. **Dead code** — Unused exports, unimported files, created-but-not-wired abstractions. If a file or export was created by this task but has zero consumers, flag as BLOCKING. Common anti-pattern: creating a shared utility or design tokens file but never importing it.
