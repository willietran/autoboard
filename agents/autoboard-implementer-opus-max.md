---
name: autoboard-implementer-opus-max
description: Implements a single task from a reviewed plan. Opus teammate for complexity 8 (Novel) tasks requiring invented approaches with no established pattern.
